...
option_list = list(
  make_option(c("-b", "--bam.file"), type="character", default=NULL,help="Path to the bam file [MANDATORY]", metavar="character"),
  make_option(c("-p", "--panel.file"), type="character", default=NULL,help="Path to the smMIP design file [MANDATORY]", metavar="character"),
  make_option(c("-s", "--sample.name"), type="character", default=NULL,help="Sample ID that will be used to name the output bam [MANDATORY]", metavar="character"),
