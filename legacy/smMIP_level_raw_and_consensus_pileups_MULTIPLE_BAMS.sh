...
############################################       R E A D  M E      ######################################################
## LEGACY: This script is no longer actively maintained. It was designed for UGE/SGE
## grid engine job submission. The pipeline now uses Level_Bas_Calls_parallel.sh with
## GNU parallel for multi-sample pileup generation. Retained here for reference.
##
